...
def combine_excel_sheets(excel_file, sheet_name1, sheet_name2):
    df_sheet1 = pd.read_excel(excel_file, sheet_name=sheet_name1, header=1)
    df_sheet2 = pd.read_excel(excel_file, sheet_name=sheet_name2, header=1)
...
def query():
    try:
        ...
        '''
        not_found_message = f"""Thank you for the question: "{user_query}."
        At the moment, I do not have access to the specific policy you’re inquiring about. If you need further assistance, I’d be happy to help connect you with the appropriate resources or team. Please let me know how I can assist further.
        """
